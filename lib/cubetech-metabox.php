...
echo '<input type="hidden" name="cubetech_future_meta_box_nonce" value="'.wp_create_nonce(basename(__FILE__)).'" />';
		...
		echo '<tr>
				...
				switch($field['type']) {
					...
					case 'image':
						...
						' . $image . '
						<input class="cubetech-upload-future-button button" type="button" value="Bild auswählen" />
